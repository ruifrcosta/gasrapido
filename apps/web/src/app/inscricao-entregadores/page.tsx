...
export default function EntregadorInscricao() {
  ...
  const handleSubmit = (e: any) => {
    ...
    alert('Inscrição de entregador enviada com sucesso!')
  }
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-3xl font-bold">Inscrição de Entregador</h1>
          <p className="mt-2 text-gray-400">
            Junte-se ao GasRápido e comece a ganhar dinheiro entregando gás
          </p>
        </div>
        ...
        <div className="bg-gray-900 rounded-lg p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label htmlFor="documentoIdentidade" className="block text-sm font-medium text-gray-300 mb-1">
              ...
              <div>
                <label htmlFor="cartaConducao" className="block text-sm font-medium text-gray-300 mb-1">
                  Carta de Condução
                </label>
                <input
                  type="text"
