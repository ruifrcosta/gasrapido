...
export default function ClienteInscricao() {
  ...
  const handleSubmit = (e: any) => {
    ...
    alert('Inscrição de cliente enviada com sucesso!')
  }
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-3xl font-bold">Inscrição de Cliente</h1>
          <p className="mt-2 text-gray-400">
            Junte-se ao GasRápido e receba gás em minutos
          </p>
        </div>
