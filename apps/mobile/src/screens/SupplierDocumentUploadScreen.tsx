...
export default function SupplierDocumentUploadScreen() {
  ...
  const requiredDocuments = [
    ...
    { id: 'businessLicense', name: 'Licença Comercial', description: 'Alvará de funcionamento ou registro comercial' },
    { id: 'insurance', name: 'Seguro de Responsabilidade', description: 'Comprovante de seguro válido' },
  ];
  ...
  const handleUploadDocument = async (documentId: string) => {
    ...
    try {
      ...
      const result = await verificationService.uploadDocument(
        userId,
        documentId as 'id' | 'license' | 'insurance',
        file
      );
  ...
  const handleSubmitForReview = async () => {
    ...
    try {
      ...
      const userId = 'current-user-id'; // This should come from auth context
      const userName = 'Fornecedor'; // This should come from user context
    ...
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>
          Fornecedor - Envie os documentos necessários para verificação
        </Text>
      </View>
